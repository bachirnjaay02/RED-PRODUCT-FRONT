...
// fetch(`https://red-product-api.railway.app/api/endpoint`);

// const API_BASE_URL = (process.env.REACT_APP_API_URL || 'https://red-product-api.railway.app/api').replace(/\/$/, '');
// const HotelList = ({ hotels, onAddHotel, currentUser, onLogout }) => (
  <>
...
const API_BASE_URL = (vite_env.REACT_APP_API_URL || 'https://red-product-db-production.up.railway.app/api').replace(/\/$/, '');
  const fetchHotels = async () => {
    try {
      ...
      setHotels([
        { id: 1, image: 'terrou bi.jpg', location: 'Boulevard Martin Luther King Dakar, 11500', name: 'Hôtel Terrou-Bi', price: '25.000' },
